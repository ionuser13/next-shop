...
const ProductItem = ({ product }) => {
  ...
  return (
    <div className={styles['ProductItem']}>
      <img src={product.images[0]} alt={product.title} className={styles['ProductItem-img']} />
      <div className={styles['product-info']}>
        ...
        <figure onClick={() => handleClick(product)} className={styles['product-info-figure']}>
          <img src={addToCartIcon} alt="add to cart button" className={styles['product-info-figure-img']} />
        </figure>
      </div>
    </div>
  );
